...
class QnAWrite extends Component {
    ...
    saveQnA= (e) => {
        ...
        let dto = {
          q_type: this.state.type,
          q_num: this.state.num,
          m_id: this.state.id,
          q_title: this.state.title,
          q_contents: this.state.contents,
          q_state: '답변 대기'
        }
          ...
          <div className={mypage.orderlist}>
            ...
            <div className={mypage.box}>
                ...
                <table className={mypage.test}>
                    ...
                    <tr>
                        <td>아이디</td>
                        <input type='text' onChange={this.onChange} name='id' value={this.state.id} readOnly className={mypage.title_input} placeholder='아이디를 입력해주세요'></input> 
                    </tr>
                    <br/>
                    <tr>
                        <td>제목</td>
